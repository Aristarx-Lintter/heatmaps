...
from src.qwen2_5.attention_injector import Qwen2_5_VisionTransformerWithHeatmap, HeatmapEmbeddingLayer
...
class Qwen2_5_VLForConditionalGenerationWithHeatmap(Qwen2_5_VLForConditionalGeneration):
    def __init__(self, config: Qwen2_5_VLConfig):
        ...
        self.heat_embedding = HeatmapEmbeddingLayer(config.vision_config.hidden_size)
